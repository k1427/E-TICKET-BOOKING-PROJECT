...
body {
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="reserved.php"><span class="glyphicon glyphicon-backward"></span> BOOK AGAIN</a></li>
    </ul>
	<ul class="nav navbar-nav navbar-right">
      <li><a href="accomodation.php"><span class="glyphicon glyphicon-backward"></span> Back To Step2</a></li>
    </ul>
	<ul class="nav navbar-nav navbar-right">
      <li><a href="passenger.php"><span class="glyphicon glyphicon-backward"></span> Back To Step3</a></li>
    </ul>
  </div>
</nav>
		...
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			<i>METRO BOOKING, Government of India</i>
			 			<h3>
